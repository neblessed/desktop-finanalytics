   ...
   return (
      <div className="dropdown_block">
         <div className="dropdown_field">
            {label && <label className="dropdown_field_label">{label}</label>}
            <div
               className="dropdown_field_area"
               onClick={() => setDropdownVisible((prev) => !prev)}
            >
               <span className={category ? '' : 'dropdown_field_placeholder'}>
                  {category ? category : placeholder}
               </span>
               <img
                  className="dropdown_icon"
                  src={
                     dropdownVisible ? './chevron_up.svg' : './chevron_down.svg'
                  }
